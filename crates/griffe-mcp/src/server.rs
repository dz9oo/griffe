...
impl ServerHandler for FreeflowServer {
    fn get_info(&self) -> ServerInfo {
        ...
        info.instructions = Some(
            "Griffe — gestion pour indépendant. Les outils exposent les mêmes commandes et \
             requêtes que la CLI `griffe`. Les actions à effet légal, financier ou \
             ...
             `pending.list`) qu'un humain doit confirmer lui-même, au terminal (`griffe \
             ...
             `griffe://clients`, `griffe://opportunities`, `griffe://missions`, \
             `griffe://quotes`, `griffe://expenses`, `griffe://fiscal-years`, \
             `griffe://company`."
                .to_string(),
        );
        info
