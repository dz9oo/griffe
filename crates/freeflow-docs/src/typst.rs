...
//! `freeflow-invoice::pdf` recopié à l'identique (voir la note de doctrine là-bas) : toute
...
pub(crate) const DISCLAIMER: &str = "Document généré par FreeFlow à partir des données saisies — \
...
/// `freeflow-invoice::pdf::Bindings`, recopié.
...
/// `freeflow-invoice::render_pdf`, sans profil PDF/A ni fichier joint.
