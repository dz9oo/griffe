...
//! [`freeflow_core::ledger`] — ce document existe aussi pour un exercice pas encore clos, comme
//! le FEC : c'est ce qu'on regarde *avant* de clore.

use freeflow_core::company::CompanyProfile;
use freeflow_core::domain::Money;
use freeflow_core::ledger::{BalanceSheet, LiabilitySection, TrialBalance};
