...
use griffe_core::domain::{FiscalYearEnd, format_date_fr};
...
#[must_use]
pub fn event_kind_fr(kind: griffe_core::day::MonthEventKind) -> &'static str {
    use griffe_core::day::MonthEventKind;
    match kind {
...
mod tests {
    ...
    fn a_state_duty_is_not_always_vat() {
        assert_eq!(
            event_kind_fr(griffe_core::day::MonthEventKind::StateDuty),
            "État"
        );
    }
