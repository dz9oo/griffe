...
fn euros(m: Option<griffe_core::domain::Money>) -> String {
    m.map_or(String::new(), griffe_core::domain::Money::to_decimal_string)
}
    ...
    Ok(html! {
        ...
        div class="panel bordered" {
            div class="detail-note" {
                "Ce que Griffe sait de votre société : factures, calendrier fiscal, clôture et \
