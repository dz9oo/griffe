...
//! desktop pont son routeur Axum vers un protocole URI custom Tauri (`griffe://`, voir
//! `griffe-desktop/src/main.rs`) ; observé en pratique, WebKitGTK ne suit pas de façon fiable
...
use griffe_core::store::Passphrase;
