...
//! `griffe_core::reference` et traduit son ambiguïté ou son absence de résultat en
...
/// plus qu'un appel à `griffe_core::reference` suivi de cet appel. `no_match` et `plural`
