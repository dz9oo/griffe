...
//! prochain geste viennent du cœur (`griffe_core::setup`) ; cette façade ne fait que les
//! afficher et, avec `--new-company`, enregistrer le choix « société nouvelle ».

use clap::Subcommand;
use griffe_core::app::{ExecutionContext, Executor};
use griffe_core::setup::{DeclareNewCompany, Prerequisite, SetupStep, setup_json, setup_status};
