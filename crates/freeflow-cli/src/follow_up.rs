...
use freeflow_core::domain::{FollowUpSubject, SnoozePreset, format_date, snooze_date};
    ...
    fn render_human(&self) -> String {
        ...
        let mut pairs = vec![
            ...
            (
                "famille",
                match self.kind {
                    freeflow_core::domain::FollowUpKind::Prospect => "prospect".to_string(),
                    freeflow_core::domain::FollowUpKind::Invoice => "impayé".to_string(),
                },
            ),
            (
                "étape",
    ...
    fn render_human(&self) -> String {
        let rows: Vec<Vec<String>> = self
            ...
            .map(|c| {
                vec![
                    match c.kind {
                        freeflow_core::domain::FollowUpKind::Prospect => "prospect".into(),
                        freeflow_core::domain::FollowUpKind::Invoice => "impayé".into(),
                    },
                    c.title.clone(),
                    c.party.clone(),
